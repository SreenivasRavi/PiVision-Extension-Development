// Version 1.0.5 sunburst-chart - https://github.com/vasturiano/sunburst-chart
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
	typeof define === 'function' && define.amd ? define(factory) :
	(global.Sunburst = factory());
...
var sunburst = Kapsule({
  ...
  update: function update(state) {
    ...
    state.svg.transition(transition$$1).tween('scale', function () {
      var xd = interpolateValue(state.angleScale.domain(), [focusD.x0, focusD.x1]);
      var yd = interpolateValue(state.radiusScale.domain(), [focusD.y0, 1]);
      return function (t) {
